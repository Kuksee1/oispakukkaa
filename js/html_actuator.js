...
dogeSayings = ['Passaa hitit', 'Silmät liikkuu vielä!', 'KKONAA', 'Perjantai!', 'Lauantai!', 'YUNG KARUUUU', ]
...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  if (tile.value > 8172) classes.push("tile-super");
...
HTMLActuator.prototype.message = function (won) {
  ...
  var message = won ? "KUNINGAS" : "VITUN REMU!";
...
HTMLActuator.prototype.goKatko = function () {
    ...
    messageElement.setAttribute('src',"/IMG/fbi.png");
    //messageElement.textContent = message;
    //var left = 'left: 37%;';
    //var top = 'top: 10%;';
